...
С помощью каскадной таблицы стилей CSS мы стилизуем наш index.html – главную страницу, которую пользователи будут видеть сразу как попадут на сайт. Только для начала необходимо сообщить HTML, что мы собираемся подключить к нему CSS.
